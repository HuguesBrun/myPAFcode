...
void HWWAnalysis::Initialise() {
    ...
    theTree->Branch("weight_runAB_Rdep",&weight_runAB_Rdep,"weight_runAB_Rdep/F");
    theTree->Branch("weight_runC_Rdep",&weight_runC_Rdep,"weight_runC_Rdep/F");
    theTree->Branch("weight_runD_Rdep",&weight_runD_Rdep,"weight_runD_Rdep/F");
...
void HWWAnalysis::compWeights(int nbVtx){
    ...
    weight_runAB_Rdep = runABdepweights[nbVtx-1];
    weight_runC_Rdep = runCdepweights[nbVtx-1];
    weight_runD_Rdep = runDdepweights[nbVtx-1];
